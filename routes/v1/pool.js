 ...
 */
router.post('/:poolName/stakePoolRegistrationCertificate', function(req, res, next) {
    res.send(cardanoCli.stakePoolRegistrationCertificate(req.params.poolName, req.body));
});

/**
 * Return Pool Deregistration Certificate Path
 */
router.get('/:poolName/stakePoolDeregistrationCertificate/:epoch', function(req, res, next) {
    res.send(cardanoCli.stakePoolDeregistrationCertificate(req.params.poolName, req.params.epoch));
});
